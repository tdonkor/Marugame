...
import { DotButton, omitPropertiesInObject, addToCartEvent, removeFromCartEvent, calculateButtonPrice, OMSEventsFacade, DotSessionService, PromotionsService, OrderDiscountResponse, DotConditionsService, PosRefintService, PosElogHandler } from 'dotsdk';
...
export class BasketService {
  ...
  public addButtonToBasket(button: DotButton, addOnlyOne = false): void {
    ...
    if (this.appSettingsService.enableOMSModule && this.appSettingsService.enableOMSRecall) {
      ...
      new OMSEventsFacade().recallEvent(this.totalPrice, false, null, orderPosNumber, refint, serviceType, orderStartTime, firstItemAddedTime).subscribe(() => null);
    }
