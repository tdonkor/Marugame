...
export class CheckoutService {
  ...
  public get calculatedOrder(): boolean {
    return this._calculatedOrder;
  }
  public set calculatedOrder(value: boolean) {
    this._calculatedOrder = value;
  }
  ...
  private _calculatedOrder = false;
  ...
  public async startCheckoutTunnel() {
    ...
    if (!this._basketButtons) {
      ...
      if (this.sameBasket() || !!this.appSettingsService.skipPrecalculate) {
  ...
  public async voidOrder() {
    if (this._openedOrder)  {
      this._openedOrder = !(await this.posOperationService.sendVoidOrderToPOS());
    } else if (this._calculatedOrder && this.appSettingsService.calculateTotalMode === CalculateTotalMode.VOID_ON_RETURN) {
      this._calculatedOrder = !(await this.posOperationService.sendVoidOrderToPOS());
    }
  }
